 ...
 */
final class Version20200406092057 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE healthcare ADD picture VARCHAR(255) NOT NULL, CHANGE price_id price_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentary CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE healthcare DROP picture, CHANGE price_id price_id INT DEFAULT NULL');
